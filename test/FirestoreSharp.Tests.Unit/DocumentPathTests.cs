...
public sealed class DocumentPathTests
{
    ...
    {
        var path = DocumentPath.Parse("projects/my-proj/databases/(default)/documents/users/alice");
    ...
    {
        var path = DocumentPath.Parse("projects/p1/databases/db1/documents/users/u1/posts/post1");
    ...
    {
        var path = DocumentPath.Parse("projects/p/databases/d/documents/a/b/c/d/e/f");
    ...
    public void ResourceName_RoundTrips()
    {
        ...
        var path = DocumentPath.Parse(name);
    ...
    {
        var path = DocumentPath.Parse("projects/p1/databases/(default)/documents/users/u1/posts/post1");
    ...
    {
        Assert.ThrowsAny<ArgumentException>(() => DocumentPath.Parse(input));
    }
    ...
    public void Parse_WrongPrefix_Throws()
    {
        Assert.Throws<ArgumentException>(() =>
            DocumentPath.Parse("buckets/b1/databases/db/documents/col/doc"));
    }
    ...
    public void Parse_OddDocumentPath_Throws()
    {
        ...
        Assert.Throws<ArgumentException>(() =>
            DocumentPath.Parse("projects/p/databases/d/documents/col/doc/subcol"));
    }
}
